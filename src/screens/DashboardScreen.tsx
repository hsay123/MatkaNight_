          ...
          <div className="md:col-span-7 flex flex-col gap-4">
            ...
            >
              ...
              <div className="mt-6 text-center">
                <span className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#5047e4] text-white text-sm font-medium group-hover:bg-[#5047e4]/90 transition-colors">
                  Select Zones →
                </span>
              </div>
            </motion.div>
